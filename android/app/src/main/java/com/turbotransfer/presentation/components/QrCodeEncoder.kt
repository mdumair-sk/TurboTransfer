...
/**
 * High-performance, zero-dependency QR Code Matrix Generator.
...
object QrCodeEncoder {
    ...
    // Version capacities for Error Correction Level M:
    // Version 1: 21x21, total data: 16 bytes, EC: 10 bytes
    // Version 2: 25x25, total data: 28 bytes, EC: 16 bytes
    // Version 3: 29x29, total data: 44 bytes, EC: 26 bytes
    // Version 4: 33x33, total data: 64 bytes, EC: 36 bytes (2 blocks of 18)
    // Version 5: 37x37, total data: 86 bytes, EC: 48 bytes (2 blocks of 24)
    // Version 6: 41x41, total data: 108 bytes, EC: 64 bytes (4 blocks of 16)
    ...
    fun encode(text: String): Array<BooleanArray> {
        ...
        // 6. Format Information (Mask 0, EC Level M: format bits = 0x5412 xor 0x5412 = 0)

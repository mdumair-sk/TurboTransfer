...
pub use super::registry::{
    ...
    register_active_transfer_with_path, remove_active_transfer, set_transfer_actor_handle,
    set_transfer_status, transfer_control_status, update_transfer_progress,
    update_transfer_transport_name, ActiveTransferRecord, TransferHandle, TransferProgress,
    TransferSummary,
};
pub use super::sender::{
    default_data_dir, find_resumable_transfer, resolve_and_connect_transports,
